...
export const nav = {
  anchors: [
    ...
    { index: "03", label: "OPEN SOURCE", href: "#open-source" },
...
export const work: WorkEntry[] = [
  ...
  },
  {
    ...
    body: "Each project gets its own system prompt and knowledge base. The server owns access control and token accounting, responses stream over SSE, and a bounded tool-calling loop covers calculator, RAG document search, and web search with automatic provider fallback. pgvector retrieval is scoped per project, so tenants never see each other's documents.",
    stack: [
      "Python",
      "FastAPI",
      "SQLAlchemy",
