/** Section 03, Open Source — curated ledger rows + recent merged PRs. */
import { formatPRDate, getRecentMergedPRs } from "@/lib/github";
import { SectionHeader } from "@/components/ui/section-header";
import { openSource, sectionIntros } from "@/lib/data";

export default async function OpenSource() {
  const { prs: recentPRs, live: prsLive } = await getRecentMergedPRs(6);

  return (
    <SectionHeader id="open-source" index="03" label="OPEN SOURCE">
      ...
      {/* Recent merged PRs — live from the API with a committed fallback */}
      <div className="mt-10">
